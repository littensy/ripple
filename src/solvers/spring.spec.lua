return function()
	...
	local snapshots = {
		default = "[0.37,0.73,0.9,0.96,0.98,0.99,0.99,0.99,0.99,0.99,0.99,1]",
		underdamped = "[0.41,0.84,1.01,1.03,1.02,1.01,0.99,0.99,0.99,0.99,1.01,1.01,1]",
		critical = "[0.36,0.71,0.89,0.95,0.98,0.99,0.99,0.99,0.99,0.99,0.99,1]",
		overdamped = "[0.31,0.6,0.78,0.87,0.93,0.96,0.97,0.98,0.99]",
		tension_200 = "[0.43,0.81,0.95,0.99,0.99,1.01,1.01,1.01,1.01,1]",
		tension_300 = "[0.61,0.98,1.03,1.01,0.99,0.99,0.99,1.01,1.01,1]",
		mass_0_5 = "[0.44,0.74,0.87,0.94,0.97,0.98,0.99,0.99,0.99,0.99,0.99,0.99,0.99,0.99,0.99,1]",
		mass_2 = "[0.27,0.67,0.92,1.03,1.05,1.03,1.02,1.01,0.99,0.99,0.99,0.99,0.99,1.01,1.01,1.01,1.01,1]",
		friction_20 = "[0.43,0.85,1.01,1.03,1.01,1.01,0.99,0.99,0.99,0.99,1.01,1]",
		friction_30 = "[0.35,0.67,0.84,0.92,0.96,0.98,0.99,0.99,0.99,0.99,0.99,0.99,0.99,0.99,0.99,1]",
	}
